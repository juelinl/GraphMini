  ...
  public:
    ...
    uint64_t operator()(Cursor bc4, bool parallel_task) const {
        ...
        for (; bc4.valid(); bc4.advance()) { // bitmap local-index loop
            ...
            b11.assign_subtraction<bitmap_words, true>(b9, v4_adj, v4_bit_idx, v4_bit_idx);
  ...
  public:
    ...
    uint64_t operator()(Cursor bc3, bool parallel_task) const {
        ...
        for (; bc3.valid(); bc3.advance()) { // bitmap local-index loop
            ...
            b9.assign_intersection<bitmap_words, true>(b7, v3_adj);
...
class BitLevel2 {
  ...
  public:
    BitLevel2(const QueryContext &query, const BitGraph &bitgraph, const BitmapTaskPolicy &policy, const Bitmap &input_b1, const Bitmap &input_b2, const Bitmap &input_b3, const Bitmap &input_b4)
        : query(query), bitgraph(bitgraph), policy(policy), input_b1(input_b1), input_b2(input_b2), input_b3(input_b3), input_b4(input_b4) {}
    uint64_t operator()() const {
    ...
    uint64_t operator()(Cursor bc2, bool parallel_task) const {
        ...
        for (; bc2.valid(); bc2.advance()) { // bitmap local-index loop
            ...
            b5.assign_subtraction<bitmap_words, true>(b1, v2_adj, v2_bit_idx);
            b6.assign_intersection<bitmap_words, true>(b3, v2_adj);
            b7.assign_intersection<bitmap_words, true>(b4, v2_adj);
            counter += BitLevel3<bitmap_words>(query, bitgraph, policy, b5, b6, b7)();
        }
        return counter;
    }
};
  ...
  public:
    ...
    uint64_t operator()(Cursor bc1, bool parallel_task) const {
        ...
        for (; bc1.valid(); bc1.advance()) { // bitmap local-index loop
            ...
            b4.assign_bounded<bitmap_words, true>(b3, v1_bit_idx);
            counter += BitLevel2<bitmap_words>(query, bitgraph, policy, b1, b2, b3, b4)();
        }
        return counter;
    }
};
  ...
  public:
    ...
    void operator()(const tbb::blocked_range<size_t> &r) const {
        ...
        for (size_t v4_idx = r.begin(); v4_idx < r.end(); v4_idx++) { // loop-4begin
            ...
            VertexSet s11 = s9.subtract(v4_adj, v4_adj.vid());
  ...
  public:
    ...
    void operator()(const tbb::blocked_range<size_t> &r) const {
        ...
        for (size_t v2_idx = r.begin(); v2_idx < r.end(); v2_idx++) { // loop-2begin
            ...
            VertexSet s5 = s1.subtract(v2_adj);
