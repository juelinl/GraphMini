    ...
    void operator()(const tbb::blocked_range<size_t> &r) const {
        ...
        for (size_t v2_idx = r.begin(); v2_idx < r.end(); v2_idx++) { // loop-2begin
            ...
            for (size_t v3_idx = 0; v3_idx < s8.size(); v3_idx++) { // loop-3 begin
                ...
                counter += 1ll * s10.size() * s11.size() * s9.size();
                /* Val: 1 | Group: (0),(1),(2) | Comp: |VSet(10)|*|VSet(11)|*|VSet(9)| */
                counter += -1ll * s10.intersect_cnt(s9) * s11.size();
                /* Val: -1 | Group: (0 2),(1) | Comp: |VSet(10) & VSet(9)|*|VSet(11)| */
                counter += -1ll * s10.size() * s11.intersect_cnt(s9);
                /* Val: -1 | Group: (0),(1 2) | Comp: |VSet(10)|*|VSet(11) & VSet(9)| */
                counter += -1ll * s10.intersect_cnt(s11) * s9.size();
                /* Val: -1 | Group: (0 1),(2) | Comp: |VSet(10) & VSet(11)|*|VSet(9)| */
                counter += 2ll * s10.intersect(s11).intersect_cnt(s9);
                /* Val: 2 | Group: (0 1 2) | Comp: |VSet(10) & VSet(11) & VSet(9)| */
            }
        }
    }
};
