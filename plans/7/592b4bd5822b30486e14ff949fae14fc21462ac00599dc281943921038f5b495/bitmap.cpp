  ...
  public:
    ...
    uint64_t operator()(Cursor bc3, bool parallel_task) const {
        ...
        for (; bc3.valid(); bc3.advance()) { // bitmap local-index loop
            ...
            b5.assign_subtraction<bitmap_words, true>(b3, v3_adj, v3_bit_idx);
            b6.assign_subtraction<bitmap_words, true>(b4, v3_adj, v3_bit_idx, v3_bit_idx);
  ...
  public:
    ...
    void operator()(const tbb::blocked_range<size_t> &r) const {
        ...
        for (size_t v3_idx = r.begin(); v3_idx < r.end(); v3_idx++) { // loop-3begin
            ...
            VertexSet s5 = s3.subtract(v3_adj);
            VertexSet s6 = s4.subtract(v3_adj, v3_adj.vid());
