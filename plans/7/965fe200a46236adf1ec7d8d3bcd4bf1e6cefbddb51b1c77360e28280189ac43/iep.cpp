...
class SetLevel2 {
  ...
  public:
    SetLevel2(const QueryContext &_query, VertexSet &_v0_adj, VertexSet &_v1_adj, VertexSet &_s2, VertexSet &_s3, VertexSet &_s4, VertexSet &_s5) : query{_query}, v0_adj{_v0_adj}, v1_adj{_v1_adj}, s2{_s2}, s3{_s3}, s4{_s4}, s5{_s5} {};
    void operator()(const tbb::blocked_range<size_t> &r) const {
        ...
        for (size_t v2_idx = r.begin(); v2_idx < r.end(); v2_idx++) { // loop-2begin
            ...
            VertexSet s8 = s3.remove(v2_adj.vid());
            ...
            for (size_t v3_idx = 0; v3_idx < s9.size(); v3_idx++) { // loop-3 begin
                ...
                counter += 1ll * s12.size() * s11.size() * s10.size();
                /* Val: 1 | Group: (0),(1),(2) | Comp: |VSet(12)|*|VSet(11)|*|VSet(10)| */
                counter += -1ll * s12.intersect_cnt(s10) * s11.size();
                /* Val: -1 | Group: (0 2),(1) | Comp: |VSet(12) & VSet(10)|*|VSet(11)| */
                counter += -1ll * s12.size() * s11.intersect_cnt(s10);
                /* Val: -1 | Group: (0),(1 2) | Comp: |VSet(12)|*|VSet(11) & VSet(10)| */
                counter += -1ll * s12.intersect_cnt(s11) * s10.size();
                /* Val: -1 | Group: (0 1),(2) | Comp: |VSet(12) & VSet(11)|*|VSet(10)| */
                counter += 2ll * s12.intersect(s11).intersect_cnt(s10);
                /* Val: 2 | Group: (0 1 2) | Comp: |VSet(12) & VSet(11) & VSet(10)| */
            }
        }
    }
};
    ...
    void operator()(const tbb::blocked_range<size_t> &r) const {
        ...
        for (size_t v1_idx = r.begin(); v1_idx < r.end(); v1_idx++) { // loop-1begin
            ...
            if (s5.size() > query.nested_thresholds[2]) {
                tbb::parallel_for(tbb::blocked_range<size_t>(0, s5.size(), 1), SetLevel2(query, v0_adj, v1_adj, s2, s3, s4, s5), tbb::auto_partitioner());
                continue;
            }
