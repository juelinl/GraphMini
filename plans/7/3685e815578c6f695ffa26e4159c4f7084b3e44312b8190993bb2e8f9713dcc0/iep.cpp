    ...
    void operator()(const tbb::blocked_range<size_t> &r) const {
        ...
        for (size_t v2_idx = r.begin(); v2_idx < r.end(); v2_idx++) { // loop-2begin
            ...
            for (size_t v3_idx = 0; v3_idx < s3.size(); v3_idx++) { // loop-3 begin
                ...
                counter += 1ll * s4.size() * s4.size() * s4.size();
                /* Val: 1 | Group: (0),(1),(2) | Comp: |VSet(4)|*|VSet(4)|*|VSet(4)| */
                counter += -1ll * s4.size() * s4.size();
                /* Val: -1 | Group: (0 2),(1) | Comp: |VSet(4) & VSet(4)|*|VSet(4)| */
                counter += -1ll * s4.size() * s4.size();
                /* Val: -1 | Group: (0),(1 2) | Comp: |VSet(4)|*|VSet(4) & VSet(4)| */
                counter += -1ll * s4.size() * s4.size();
                /* Val: -1 | Group: (0 1),(2) | Comp: |VSet(4) & VSet(4)|*|VSet(4)| */
                counter += 2ll * s4.intersect(s4).intersect_cnt(s4);
                /* Val: 2 | Group: (0 1 2) | Comp: |VSet(4) & VSet(4) & VSet(4)| */
            }
        }
    }
};
