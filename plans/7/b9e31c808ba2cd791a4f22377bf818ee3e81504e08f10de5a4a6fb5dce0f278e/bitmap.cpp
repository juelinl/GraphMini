...
class BitLevel4 {
  ...
  public:
    BitLevel4(const QueryContext &query, const BitGraph &bitgraph, const BitmapTaskPolicy &policy, const Bitmap &input_b5)
  ...
  public:
    ...
    uint64_t operator()(Cursor bc3, bool parallel_task) const {
        ...
        for (; bc3.valid(); bc3.advance()) { // bitmap local-index loop
            ...
            b5.assign_intersection<bitmap_words, true>(b4, v3_adj);
            counter += BitLevel4<bitmap_words>(query, bitgraph, policy, b5)();
        }
        return counter;
    }
};
