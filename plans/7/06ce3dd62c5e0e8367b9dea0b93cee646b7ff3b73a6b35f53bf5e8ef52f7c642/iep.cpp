    ...
    void operator()(const tbb::blocked_range<size_t> &r) const {
        ...
        for (size_t v2_idx = r.begin(); v2_idx < r.end(); v2_idx++) { // loop-2begin
            ...
            for (size_t v3_idx = 0; v3_idx < s5.size(); v3_idx++) { // loop-3 begin
                ...
                counter += 1ll * s7.size() * s6.size() * s6.size();
                /* Val: 1 | Group: (0),(1),(2) | Comp: |VSet(7)|*|VSet(6)|*|VSet(6)| */
                counter += -1ll * s7.intersect_cnt(s6) * s6.size();
                /* Val: -1 | Group: (0 2),(1) | Comp: |VSet(7) & VSet(6)|*|VSet(6)| */
                counter += -1ll * s7.size() * s6.size();
                /* Val: -1 | Group: (0),(1 2) | Comp: |VSet(7)|*|VSet(6) & VSet(6)| */
                counter += -1ll * s7.intersect_cnt(s6) * s6.size();
                /* Val: -1 | Group: (0 1),(2) | Comp: |VSet(7) & VSet(6)|*|VSet(6)| */
                counter += 2ll * s7.intersect(s6).intersect_cnt(s6);
                /* Val: 2 | Group: (0 1 2) | Comp: |VSet(7) & VSet(6) & VSet(6)| */
            }
        }
    }
};
