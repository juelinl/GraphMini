...
class BitLevel5 {
  ...
  public:
    ...
    uint64_t operator()() const {
        return bitmap_for_each(input_b6, false, *this, policy, 1, 0);
    }
...
class BitLevel4 {
  ...
  public:
    ...
    uint64_t operator()() const {
        return bitmap_for_each(input_b5, true, *this, policy, 0, query.nested_thresholds[4]);
    }
    template <class Cursor>
                        ...
                        for (size_t v3_idx = 0; v3_idx < s3.size(); v3_idx++) { // loop-3 begin
                            ...
                            { // full bitmap region
                                auto bitmap_execute = [&](auto bitmap_tag) {
                                    ...
                                    return BitLevel4<bitmap_words>(query, bitgraph, bitmap_task_policy, b5)();
                                };
