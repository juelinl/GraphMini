...
class BitLevel5 {
  ...
  public:
    ...
    uint64_t operator()() const {
        return bitmap_for_each(input_b12, false, *this, policy, 2, 0);
    }
...
class BitLevel4 {
  ...
  public:
    ...
    uint64_t operator()() const {
        return bitmap_for_each(input_b10, true, *this, policy, 1, query.nested_thresholds[4]);
    }
    template <class Cursor>
                    ...
                    for (size_t v2_idx = 0; v2_idx < s1.size(); v2_idx++) { // loop-2 begin
                        ...
                        { // full bitmap region
                            auto bitmap_execute = [&](auto bitmap_tag) {
                                ...
                                return BitLevel3<bitmap_words>(query, bitgraph, bitmap_task_policy, b4, b5, b6, b7)();
                            };
