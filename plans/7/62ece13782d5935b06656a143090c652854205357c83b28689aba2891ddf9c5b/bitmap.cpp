...
class BitLevel5 {
  ...
  public:
    ...
    uint64_t operator()() const {
        return bitmap_for_each(input_s11, false, *this, policy, 4, 0);
    }
...
class BitLevel4 {
  ...
  public:
    BitLevel4(const QueryContext &query, const BitGraph &bitgraph, const BitmapTaskPolicy &policy, const Bitmap &input_s8, const Bitmap &input_s9)
    ...
    uint64_t operator()(Cursor bc4, bool parallel_task) const {
        ...
        for (; bc4.valid(); bc4.advance()) { // bitmap local-index loop
            ...
            s11.assign_bounded<bitmap_words, true>(s9, v4_bit_idx);
...
class BitLevel3 {
  ...
  public:
    BitLevel3(const QueryContext &query, const BitGraph &bitgraph, const BitmapTaskPolicy &policy, const Bitmap &input_s5, const Bitmap &input_s6, const Bitmap &input_s7)
    ...
    uint64_t operator()(Cursor bc3, bool parallel_task) const {
        ...
        for (; bc3.valid(); bc3.advance()) { // bitmap local-index loop
            ...
            s9.assign_intersection<bitmap_words, true>(s7, v3_adj);
            counter += BitLevel4<bitmap_words>(query, bitgraph, policy, s8, s9)();
        }
        return counter;
    }
};
...
class BitLevel2 {
  ...
  public:
    BitLevel2(const QueryContext &query, const BitGraph &bitgraph, const BitmapTaskPolicy &policy, const Bitmap &input_s1, const Bitmap &input_s2, const Bitmap &input_s3, const Bitmap &input_s4)
        : query(query), bitgraph(bitgraph), policy(policy), input_s1(input_s1), input_s2(input_s2), input_s3(input_s3), input_s4(input_s4) {}
    uint64_t operator()() const {
    ...
    uint64_t operator()(Cursor bc2, bool parallel_task) const {
        ...
        for (; bc2.valid(); bc2.advance()) { // bitmap local-index loop
            ...
            s5.assign_removed<bitmap_words, true>(s1, v2_bit_idx);
            const auto v2_adj = bitgraph.local_row(v2_bit_idx);
            s6.assign_intersection<bitmap_words, true>(s3, v2_adj);
            s7.assign_intersection<bitmap_words, true>(s4, v2_adj);
            counter += BitLevel3<bitmap_words>(query, bitgraph, policy, s5, s6, s7)();
        }
        return counter;
    }
};
  ...
  public:
    ...
    uint64_t operator()(Cursor bc1, bool parallel_task) const {
        ...
        for (; bc1.valid(); bc1.advance()) { // bitmap local-index loop
            ...
            s4.assign_bounded<bitmap_words, true>(s3, v1_bit_idx);
            counter += BitLevel2<bitmap_words>(query, bitgraph, policy, s1, s2, s3, s4)();
        }
        return counter;
    }
};
  ...
  public:
    ...
    void operator()(const tbb::blocked_range<size_t> &r) const {
        ...
        for (size_t v4_idx = r.begin(); v4_idx < r.end(); v4_idx++) { // loop-4begin
            ...
            VertexSet s11 = s9.bounded(v4_adj.vid());
  ...
  public:
    ...
    void operator()(const tbb::blocked_range<size_t> &r) const {
        ...
        for (size_t v3_idx = r.begin(); v3_idx < r.end(); v3_idx++) { // loop-3begin
            ...
            VertexSet s9 = s7.intersect(v3_adj);
