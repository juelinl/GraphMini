    ...
    void operator()(const tbb::blocked_range<size_t> &r) const {
        ...
        for (size_t v2_idx = r.begin(); v2_idx < r.end(); v2_idx++) { // loop-2begin
            ...
            for (size_t v3_idx = 0; v3_idx < s5.size(); v3_idx++) { // loop-3 begin
                ...
                counter += 1ll * s8.size() * s10.size() * s9.size();
                /* Val: 1 | Group: (0),(1),(2) | Comp: |VSet(8)|*|VSet(10)|*|VSet(9)| */
                counter += -1ll * s8.intersect_cnt(s9) * s10.size();
                /* Val: -1 | Group: (0 2),(1) | Comp: |VSet(8) & VSet(9)|*|VSet(10)| */
                counter += -1ll * s8.size() * s10.intersect_cnt(s9);
                /* Val: -1 | Group: (0),(1 2) | Comp: |VSet(8)|*|VSet(10) & VSet(9)| */
                counter += -1ll * s8.intersect_cnt(s10) * s9.size();
                /* Val: -1 | Group: (0 1),(2) | Comp: |VSet(8) & VSet(10)|*|VSet(9)| */
                counter += 2ll * s8.intersect(s10).intersect_cnt(s9);
                /* Val: 2 | Group: (0 1 2) | Comp: |VSet(8) & VSet(10) & VSet(9)| */
            }
        }
    }
};
