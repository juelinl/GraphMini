    ...
    void operator()(const tbb::blocked_range<size_t> &r) const {
        ...
        for (size_t v1_idx = r.begin(); v1_idx < r.end(); v1_idx++) { // loop-1begin
            ...
            for (size_t v2_idx = 0; v2_idx < s2.size(); v2_idx++) { // loop-2 begin
                ...
                /* Val: 1 | Group: (0),(1),(2) | Comp: |VSet(5)|*|VSet(6)|*|VSet(4)| */
                counter += -1ll * s5.intersect_cnt(s4) * s6.size();
                /* Val: -1 | Group: (0 2),(1) | Comp: |VSet(5) & VSet(4)|*|VSet(6)| */
                counter += -1ll * s5.size() * s6.intersect_cnt(s4);
                /* Val: -1 | Group: (0),(1 2) | Comp: |VSet(5)|*|VSet(6) & VSet(4)| */
                counter += -1ll * s5.intersect_cnt(s6) * s4.size();
                /* Val: -1 | Group: (0 1),(2) | Comp: |VSet(5) & VSet(6)|*|VSet(4)| */
                counter += 2ll * s5.intersect(s6).intersect_cnt(s4);
                /* Val: 2 | Group: (0 1 2) | Comp: |VSet(5) & VSet(6) & VSet(4)| */
            }
        }
    }
};
